      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="text-lg leading-8 text-muted-foreground mb-12">
            ...
            and collaborating on cutting-edge AI solutions. Let's connect and explore 
          ...
          <div className="flex justify-center space-x-8">
            <a 
              href="https://www.linkedin.com/in/rihanat-idowu" 
              target="_blank"
            ...
            <a 
              href="https://github.com/NyxBelle" 
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors duration-200"
              aria-label="GitHub"
